...
const PasswordSvg = ({fill ,fillIn="none"}) => {
  const { currentMode } = useStateContext();
  
  
  return (
    <svg className='w-5 h-5' height="800px" width="800px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 512 512"  xml:space="preserve">
{/* <style type="text/css">
	.st0{fill:#000000;}
</style> */}
<g>
	<path fill={currentMode =="Dark"?"#bdbdbd":"#a1a1a1"} class="st0" d="M256,0c-81.814,0-148.379,66.565-148.379,148.38c0,32.361,10.236,63.116,29.602,88.939
	...
	<path fill={currentMode =="Dark"?"#bdbdbd":"#a1a1a1"} class="st0" d="M256.828,72.862c-14.609,0-26.458,11.843-26.458,26.458c0,14.608,11.849,26.451,26.458,26.451
		c14.608,0,26.458-11.843,26.458-26.451C283.285,84.705,271.436,72.862,256.828,72.862z"/>
	<path fill={currentMode =="Dark"?"#bdbdbd":"#a1a1a1"} class="st0" d="M242.709,450H256V274.867c-4.49,0-8.925-0.241-13.29-0.697V450z"/>
</g>
</svg>
